...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer(f"There is something wrong \n\n <b>1-May Be Spelling Mistake</b> \n\n <b>2-May be Movie is not Released or Still in Theaters</b> \n\n <b>3-May be that movie is not our database</b>", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
