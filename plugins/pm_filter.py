...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('m', url='https://t.me/+BQP56d3IH0piYjM1'),
                InlineKeyboardButton('m', url='https://t.me/JosProjects')
            ],
            [
                InlineKeyboardButton('Series & Movie Club', url=f'https://t.me/+y53tWFUw6Q43NzE9')
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Main Channel❤️', url='https://t.me/+BQP56d3IH0piYjM1'),
            InlineKeyboardButton('Series Channel🖤', url='https://t.me/joinchat/9w9cP_Yxylc4MTk1')
            ],[
            InlineKeyboardButton('Main Group💝', url='https://t.me/Filmhunters123')
            ],[
            InlineKeyboardButton('PRE DVD💚', url='https://t.me/+CcIlxBS_WIMyNmNl'),
            InlineKeyboardButton('OTT Movies💙', url='https://t.me/+txtUUj8amJIyZjA1')
            ],[
